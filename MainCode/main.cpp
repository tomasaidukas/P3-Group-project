...
int main(){
    ...
    Analytic ana_alg(100,100,10,0.5,0.00001);//sets up the analytical variables
    Analytic num_alg(100,100,10,0.5,0.00001);//sets up the numerical values for an analytical solution
