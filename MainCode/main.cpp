...
int main(){
    ...
    Analytic ana_alg(1000,1000,20,100,0.001);//sets up the analytical variables
    Analytic num_alg(1000,1000,20,100,0.001);//sets up the numerical values for an analytical solution
    ...
    printElectric() first argument:
	1 => analytical plot
	2 => numerical with circle inside plot
	3 => numerical from an image plot  
    runElectric() second argument:
	spacing between points being put to a data file
