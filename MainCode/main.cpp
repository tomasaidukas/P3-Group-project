...
int main(){
    ...
    Analytic ana_alg(500,500,20,100,0.001);//sets up the analytical variables
    Analytic num_alg(500,500,20,100,0.001);//sets up the numerical values for an analytical solution
